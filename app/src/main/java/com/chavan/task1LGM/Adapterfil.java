...
public class Adapterfil extends RecyclerView.Adapter<Adapterfil.VPFragment>{
    List<Model> modelList;

    public Adapterfil(List<Model> modelList) {
